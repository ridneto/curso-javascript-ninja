...
var justNumers = numberObjects.map(function(item){ return item.number; });

console.log(justNumers);
...
var justMod2Or3 = justNumers.filter(function(item){
...
var reduceI = name.reduceRight(function(acumulado, item){
...
var obj = numberObjects.lastIndexOf(obj);
...
console.log(Array.isArray(justMod2Or3) ? justMod2Or3.join(" ") : "Não é array!");
