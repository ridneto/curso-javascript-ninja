...
(function(){
  ...
  */
  var array = [1, 2, 'irineu', 'vc n sabe, nem eu'];
  ...
  */
  ...
  var norte = ['Acre', 'Amapá', 'Amazonas', 'Pará', 'Rondônia', 'Roraima', 'Tocantis'];
  ...
  */
  // ?
  var nordeste = ['Maranhão', 'Piauí', 'Ceará', 'Rio Grande do Norte', 'Paraíba', 'Pernambua',
  ...
  */
  // ?
  var newSudeste = brasil.splice(6, 3);
  /*
  ...
  */
  ...
  var flag = brasil.every(function(item){return item.length > 7;})
  // ?
  ...
  */
  ...
  var flag = brasil.some(function(item){return item === 'Ceará';})
